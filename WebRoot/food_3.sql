...
insert  into `t_food`(`foodid`,`foodname`,`unitprice`,`filepath`) values (2,'美食二',60,'upload/3.png'),(4,'美食三',34,'upload/4.png'),(5,'美食四',43,'upload/5.png'),(6,'美食五',54,'upload/6.png'),(7,'收到',34,'8.png'),(8,'sdsd',343,'8.png'),(9,'gg',45,'8.png');
